...
type Props = {
    ...
    onSave:(payload:CreateEvideaDeliveryPayload)=>void;

};



export function EvideaCreateModal({
    ...
    const [form,setForm] =
        useState<CreateEvideaDeliveryPayload>({
    ...
    function update(
        key:keyof CreateEvideaDeliveryPayload,
        value:string
    ){
                ...
                ">
                    ...
                    <div>
                        ...
                        <p className="text-sm text-slate-500">
                            Evidea operasyon kaydı oluştur.
                        </p>
