export type EvideaDeliveryStatus =
    | "Yolda"
    | "Teslim Noktasında"
    | "Beklemede"
    | "Teslim Edildi"
...
export type EvideaDelivery = {
    ...
    seyir_durumu:EvideaDeliveryStatus;

    gerceklesen_teslim_tarihi:string | null;

    gerceklesen_teslim_saati:string | null;

    history?: EvideaDeliveryHistory[];

};


export type EvideaSummary = {
...
export type CreateEvideaDeliveryPayload = {
...
export type EvideaDeliveryHistory = {
